      ...
      child: Row(
        children: [
          Expanded(
            flex: 3,
            child: Text(category,
              style: GoogleFonts.manrope(fontSize: 12.5, color: textPrimary, fontWeight: FontWeight.w600)),
          ),
          const SizedBox(width: 8),
          Expanded(
            flex: 2,
            child: Text(duration,
              style: GoogleFonts.manrope(fontSize: 12, color: AppColors.primary, fontWeight: FontWeight.w700),
